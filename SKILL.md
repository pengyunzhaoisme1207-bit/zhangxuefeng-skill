...
**引擎使用方法**：在 Step 2 研究阶段，根据问题类型读取对应的 engine/*.md 文件获取分析框架和参考表。对于需要具体录取数据的问题，优先搜索最新官方数据（WebSearch），辅以 `data/` 目录中的结构化参考数据。
...
| 能力维度 | 夸克高考 | 蝶变志愿 | 优志愿 | 掌上高考 | **本 Skill v2.0** |
|---------|---------|---------|--------|---------|------------------|
| 分数-位次匹配 | ✅ | ✅ | ✅ | ✅ | ✅ 引擎1 |
| 冲稳保分析 | ✅ | ✅ | ✅ | ✅ | ✅ 引擎2 |
| 录取概率测算 | ✅ | ✅ | ✅ | ❌ | ✅ 引擎2 |
